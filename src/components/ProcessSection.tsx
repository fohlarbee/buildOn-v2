      ...
      <section className="relative px-6 py-10 lg:min-h-[640px] lg:py-12 xl:h-[681px] xl:px-0 xl:py-0">
        <div className="flex flex-col gap-6 lg:mx-auto lg:max-w-[min(560px,92vw)] lg:gap-8 xl:absolute xl:left-[70px] xl:top-[67px] xl:mx-0 xl:w-[515px] xl:max-w-none xl:gap-[37px]">
          <div className="flex items-center gap-[17px]">
            ...
            <p className="font-display text-[20px] font-bold leading-normal text-black whitespace-nowrap">
              OUR PROCESS
            </p>
          </div>
        ...
        <div className="mt-8 flex flex-col gap-4 lg:mx-auto lg:mt-10 lg:max-w-[min(960px,96vw)] lg:gap-5 xl:absolute xl:left-[70px] xl:top-[303px] xl:mt-0 xl:w-[1307px] xl:max-w-none xl:gap-[31px]">
          {/* Step 01 - highlighted */}
          <div className="flex h-[80px] w-full items-center gap-4 rounded-[24px] border border-[rgba(0,0,0,0.06)] bg-[#0056a1] motion-safe:transition-transform motion-safe:duration-300 motion-safe:ease-out motion-safe:hover:-translate-y-0.5 lg:h-[90px] lg:gap-[14px] lg:rounded-[28px] xl:h-[97px] xl:gap-[16px] xl:rounded-[32px]">
            <div className="flex w-[70px] flex-col items-center justify-center p-[10px] xl:w-[87px]">
              <p className="font-display text-[32px] font-extrabold capitalize leading-normal text-[#030033] lg:text-[40px] xl:w-[70px] xl:text-[48px]">
                {steps[0].num}
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4 lg:flex-col xl:flex-row xl:gap-[43px]">
            {steps.slice(1).map((step) => (
              <div
                key={step.num}
                className="flex h-[80px] w-full items-center gap-4 rounded-[24px] border border-[#0056a1] bg-[rgba(226,237,223,0.05)] motion-safe:transition-[transform,box-shadow] motion-safe:duration-300 motion-safe:ease-out motion-safe:hover:-translate-y-0.5 motion-safe:hover:shadow-[0_8px_24px_rgba(0,86,161,0.12)] lg:h-[90px] lg:gap-[14px] lg:rounded-[28px] lg:px-2 xl:h-[97px] xl:w-[405px] xl:gap-[16px] xl:rounded-[32px] xl:px-[10px]"
              >
                <div className="flex w-[80px] flex-col items-center justify-center p-[10px] xl:w-[103px]">
                  <p className="font-display text-[32px] font-extrabold capitalize leading-normal text-[#0056a1] lg:text-[40px] xl:w-[87px] xl:text-[48px]">
                    {step.num}
                  </p>
                </div>
                <div className="flex flex-col items-start gap-[4px] capitalize leading-normal xl:w-[259px]">
                  <p className="font-display text-[16px] font-normal text-black lg:text-[17px] xl:w-full xl:text-[20px]">
                    {step.title}
                  </p>
                  <p className="font-display text-[11px] font-light text-[rgba(0,0,0,0.6)] xl:w-full xl:text-[12px]">
                    {step.desc}
                  </p>
                </div>
              </div>
